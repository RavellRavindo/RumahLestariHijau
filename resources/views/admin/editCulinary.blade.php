...
<form method='POST' enctype="multipart/form-data" action="{{ route('adminEditTable', ['culinary', $culinary->id]) }}">
    @csrf
    <div class="form-group">
        <label for="name">Name Culinary</label>
        <input id="name" value="{{$culinary->name}}" type="text" class="form-control" name='name' placeholder="Sop Buntut">
        @error('name')
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name="description" id="description" cols="30" rows="10">{{$culinary->description}}</textarea>
        @error('description')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <input id="price" type="number" class="form-control" name='price' placeholder="100000" value="{{$culinary->price}}">
        @error('price')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="form-group">
        ...
        <input id="like" type="number" class="form-control" name='like' placeholder="9600" value="{{$culinary->like}}">
        @error('like')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
