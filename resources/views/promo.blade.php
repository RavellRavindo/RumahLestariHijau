...
@endphp
  ...
  <div id="carousel">
      ...
      @foreach ($cre as $data)
      <div class="slidePromo"><a href="#"><img src="{{Storage::url($data->photo)}}" style="height:220px; width:400px" class="promoImage"></a></div>
      @endforeach
      {{-- <div class="slidePromo"><a href="#"><img src="gambar/contohgambar.png" class="promoImage"></a></div>
      <div class="slidePromo"><a href="#"><img src="gambar/contohgambar.png" class="promoImage"></a></div>
  ...
  {{-- Last Activity! --}}
  <div style="font-size: 250%; margin-left: 5%; color: #3bb143; font-weight: bold; margin-bottom: 2%; margin-top: 2%;">Last<b style="color: #006400"> Activity!</b></div>
  <div id="carousel2">
